---
description: Typescript definitions for push messages.
---

# Typescript Definitions

[GitHub source link](https://github.com/agile-ventures/TaaS/blob/master/AgileVentures.TezPusher.Model/Typescript/contracts.d.ts)
